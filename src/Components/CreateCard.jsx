...
const CreateCard = (props) => {
    ...
    return (
        ...
        <div className="grid grid-cols-2 gap-20 ">
            <div className="w-full flex justify-center">
                <div className="w-4/5 border-2 border-black shadow-xl px-3 py-1">
                    <div className="w-full flex justify-center">
                        <h1 className="w-4/5 border-2 border-dashed border-black flex justify-center text-xl text-center font-bold py-2">What's this location?</h1>
                    </div>
        ...
        <div className="w-full flex items-center justify-center mt-5">
            <div className="rounded-xl bg-gray-500 p-2"><AddIcon className="text-3xl" /></div>
        </div>
        <div className="w-full text-end mt-5">
            <button className="bg-blue-800 text-white px-6 py-2 rounded-md text-xl mb-20 mr-10">Save</button>
        </div>
    </>
