    ...
    return (
        <>
            <div className="fixed h-16 bg-blue-800 top-0 right-0 left-0 flex items-center px-10">
                <Link to="/home" className="text-2xl text-white font-mono w-1/12">StudEase</Link>
                {
                    props.changeUI ?
                        <div className="w-11/12 flex justify-between">
                            <div className="flex items-center w-2/5 justify-between ">
                                <Link to="/about" className="text-2xl text-white font-mono font-bold">About</Link>
                                <button className="text-white text-2xl font-mono font-bold inline-flex items-center" type="button">Your Subject
                                    <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                                    </svg>
                                </button>
                                <button className="text-white text-2xl font-mono font-bold inline-flex items-center" type="button">Your Class
                                    <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                                    </svg>
                                </button>
                                ...
                                <form className="w-1/2" onSubmit={() => navigate("/search")}>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="search" id="default-search"
                                            ...
                                            placeholder="Flash cards, quizzes, questions..." required />
